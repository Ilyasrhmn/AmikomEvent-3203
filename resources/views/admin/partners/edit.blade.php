    ...
    <div class="p-6 max-w-2xl mx-auto">
        ...
        <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST"
            ...
            <div class="px-6 py-4 border-b border-slate-200 bg-slate-50">
                <h3 class="text-sm font-semibold text-slate-600 uppercase tracking-wide">Detail Partner</h3>
            </div>

            <div class="p-6">

                <div class="mb-4">
                    <label class="block mb-2 font-medium text-slate-700">Nama Partner</label>
                ...
                <div class="mb-6">
                    <label class="block mb-2 font-medium text-slate-700">Logo URL</label>
                    <input type="text" name="logo_url" value="{{ old('logo_url', $partner->logo_url) }}"
                        class="w-full border border-slate-200 px-4 py-2.5 rounded-lg focus:ring focus:ring-indigo-100 focus:border-indigo-400 outline-none"
                        placeholder="Contoh: https://Webanda.com" required>
                </div>
            </div>
